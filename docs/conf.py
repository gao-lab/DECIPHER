...
nbsphinx_thumbnails = {
    "tutorials/train_model": "_static/Model.png",
    "tutorials/explain_variance": "_static/gallery_thumb/regress.png",
    "tutorials/explain_select_genes": "_static/gallery_thumb/select_gene.png",
}
